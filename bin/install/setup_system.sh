...
echo "[INFO] Installing system dependencies (git, sudo, dpkg, python3-pip, python3-venv, docker.io, curl)..."
apt update
apt install -y git sudo dpkg gcc python3-pip python3-venv python3-dev docker.io docker-compose-v2 curl
