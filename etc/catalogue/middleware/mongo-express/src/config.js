...
const adminPassword = getFileEnv('ME_CONFIG_MONGODB_ADMINPASSWORD');
if (adminPassword) {
    // Inject the mongo connection password.
    const connectionURL = new URL(mongo.connectionString);
    connectionURL.password = adminPassword;
    mongo.connectionString = connectionURL.href;
}
